...
using SelfFinanceBlazor.Exceptions;
using SelfFinanceBlazor.Services.RoutesCollection;
using System.Net;

namespace SelfFinanceBlazor.Services.ViewModelServices
{
    abstract public class BaseService
    {
        ...
        {
            string adressHost = appConfig["AddressAPI"] ?? throw new InvalidOperationException("Address Host is invalid!");
